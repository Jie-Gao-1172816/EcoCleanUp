...
def volunteer_home():
     ...
     Methods:
     - get: Renders the homepage for the current volunteer, or an "Access
     ...
     if 'loggedin' not in session:
          ...
          # The user isn't logged in with a volunteer account, so return an
     ...
     # The user is logged in with a volunteer account, so render the volunteer
