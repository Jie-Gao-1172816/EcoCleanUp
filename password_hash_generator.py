...
users = [
    ...
    UserAccount('noah.admin', 'AdminB!2026'),

    # Event Leaders (5)
    UserAccount('sophie.king', 'Lead!2026-SK'),
    UserAccount('ethan.chen', 'Lead!2026-EC'),
    UserAccount('ava.patel', 'Lead!2026-AP'),
    UserAccount('jack.wilson', 'Lead!2026-JW'),
    UserAccount('mia.ngata', 'Lead!2026-MN'),

    # Volunteers (20)
    UserAccount('liam.brown', 'Vol!2026-LB'),
    UserAccount('olivia.wang', 'Vol!2026-OW'),
    UserAccount('lucas.li', 'Vol!2026-LL'),
    UserAccount('isla.taylor', 'Vol!2026-IT'),
    UserAccount('henry.zhang', 'Vol!2026-HZ'),
    UserAccount('charlotte.lee', 'Vol!2026-CL'),
    UserAccount('benjamin.ng', 'Vol!2026-BN'),
    UserAccount('emma.roberts', 'Vol!2026-ER'),
    UserAccount('william.singh', 'Vol!2026-WS'),
    UserAccount('mia.harris', 'Vol!2026-MH'),
    UserAccount('james.miller', 'Vol!2026-JM'),
    UserAccount('grace.ahmed', 'Vol!2026-GA'),
    UserAccount('daniel.kim', 'Vol!2026-DK'),
    UserAccount('zoe.martin', 'Vol!2026-ZM'),
    UserAccount('ryan.clark', 'Vol!2026-RC'),
    UserAccount('ella.johnson', 'Vol!2026-EJ'),
    UserAccount('kai.robinson', 'Vol!2026-KR'),
    UserAccount('chloe.moore', 'Vol!2026-CM'),
    UserAccount('leo.anderson', 'Vol!2026-LA'),
    UserAccount('hana.williams', 'Vol!2026-HW'),]
